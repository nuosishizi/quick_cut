...
```bash
# Windows
gh attestation verify ./QuickCut-Windows-2.7.46-Setup.exe --repo secure-artifacts/quick_cut

# macOS
gh attestation verify ./QuickCut-macOS-2.7.46-Installer.dmg --repo secure-artifacts/quick_cut
```
